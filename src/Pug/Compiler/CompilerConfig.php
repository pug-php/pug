...
abstract class CompilerConfig
{
     ...
     * @var array
     */
    protected $selfClosing = ['meta', 'img', 'link', 'input', 'source', 'area', 'base', 'col', 'br', 'hr'];

    /**
     * @var array
     */
    protected $phpKeywords = ['true', 'false', 'null', 'switch', 'case', 'default', 'endswitch', 'if', 'elseif', 'else', 'endif', 'while', 'endwhile', 'do', 'for', 'endfor', 'foreach', 'endforeach', 'as', 'unless'];

    /**
     * @var array
     */
    protected $phpOpenBlock = ['switch', 'if', 'else if', 'elseif', 'else', 'while', 'do', 'foreach', 'for', 'unless'];

    /**
     * @var array
     */
    protected $phpCloseBlock = ['endswitch', 'endif', 'endwhile', 'endfor', 'endforeach'];
}
